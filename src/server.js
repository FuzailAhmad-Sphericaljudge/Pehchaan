...
function defaultContentPages() {
  ...
  // Phase 35: DRAFT — PENDING LEGAL REVIEW. Seed text for the legal pages,
  // grounded in the product's actual data practices (phone-number auth with
  // OTP, worker-owned wage/safety/complaint records, NGO caseworker access to
  // assigned cases only, employer access to consented records only, evidence
  // files scanned for malware, self-service export and deletion).
  const privacyEn = [
    '## What we collect',
    '',
    'Pehchaan keeps the record you build: your name and phone number, the jobs and worksites you add, wage entries, safety check-ins, complaints, and any photos or documents you upload as evidence. We store when you used the app, which language you use, and basic technical logs needed to run the service.',
    '',
    '## Why we collect it',
    '',
    'Your record exists so that you can prove your work history, and so that a caseworker of a partner NGO can help you if you file a complaint or ask for help. Wage entries and check-ins also help you keep your own history in one place.',
    '',
    '## Who can see what',
    '',
    '- **You** see everything in your record, and can export or delete it.',
    '- **NGO caseworkers** see the cases assigned to them, including your name, complaint details, and evidence. They do not see your other cases or other NGOs\' data.',
    '- **NGO admins** manage their organization\'s cases and team, and see the same case content as their caseworkers.',
    '- **Employers** only see wage records you have consented to share with them — promised versus paid amounts and your dispute responses. They never see your complaints, evidence, safety check-ins, or other jobs.',
    '- **Platform staff** run the service. They can see account status and technical logs, and never see the content of your cases.',
    '',
    '## Evidence files',
    '',
    'Photos and documents you upload are stored privately, scanned for malware, and shared only with the caseworkers assigned to that case. Each file is kept for a limited period and then removed.',
    '',
    '## How long we keep your data',
    '',
    'Your account record is kept while your account is active. Complaints and case records are kept while a case is open and for a reasonable period afterwards so that a pattern of abuse by the same employer can be recognized. Evidence files are removed on a schedule. Technical logs are kept for a short period for security.',
    '',
    '## Deleting or exporting your data',
    '',
    'You can export your entire record yourself from the worker app as PDF, CSV, or JSON. You can request deletion of your account and data from your profile, or by asking your NGO caseworker. Deletion removes your personal details; some case records may be kept in a form that does not identify you, where the law requires it.',
    '',
    '## Location',
    '',
    'Your location is used only when you attach it to a safety check-in or a complaint, and only when you tick the consent box first. It is shared with the caseworkers handling that alert or case.',
    '',
    '## Changes to this policy',
    '',
    'When this policy changes, the old versions stay available so you can see what changed and when.',
    '',
    '---',
    '',
    '*DRAFT — PENDING LEGAL REVIEW. This text is a plain-language draft generated for the Pehchaan pilot. It must be reviewed and approved by a qualified lawyer before it is relied upon or published as the final policy.*',
  ].join('\n');
  const privacyHi = [
    '## हम क्या जानकारी रखते हैं',
    '',
    'पहचान आपका बनाया हुआ रिकॉर्ड रखती है: आपका नाम और मोबाइल नंबर, आपके काम और काम की जगहें, मजदूरी की एंट्री, सुरक्षा चेक-इन, शिकायतें, और सबूत के तौर पर अपलोड की गई तस्वीरें या कागज़ात। साथ ही आपने ऐप कब इस्तेमाल किया, आपकी भाषा, और सेवा चलाने के लिए ज़रूरी तकनीकी जानकारी भी रखी जाती है।',
    '',
    '## क्यों रखते हैं',
    '',
    'यह रिकॉर्ड इसलिए है ताकि आप अपने काम का सबूत रख सकें, और शिकायत या मदद की ज़रूरत पर साझेदार NGO का केसवर्कर आपकी मदद कर सके। मजदूरी और चेक-इन की एंट्री आपका अपना इतिहास एक जगह रखने में भी मदद करती है।',
    '',
    '## कौन क्या देख सकता है',
    '',
    '- **आप** अपना पूरा रिकॉर्ड देख सकते हैं, और उसे निर्यात या हटा सकते हैं।',
    '- **NGO केसवर्कर** वही केस देखते हैं जो उन्हें सौंपे गए हैं — आपका नाम, शिकायत की बातें और सबूत। आपके बाकी केस या दूसरे NGO का डेटा वे नहीं देखते।',
    '- **NGO एडमिन** अपने संस्था के केस और टीम संभालते हैं, और उतना ही देखते हैं जितना उनके केसवर्कर।',
    '- **कारोबारी (एम्प्लॉयर)** केवल वही मजदूरी रिकॉर्ड देखते हैं जिन्हें साझा करने की आपने सहमति दी है — वादा की गई और दी गई मजदूरी, और आपके जवाब। आपकी शिकायतें, सबूत, चेक-इन या दूसरे काम वे कभी नहीं देखते।',
    '- **प्लेटफॉरम टीम** सेवा चलाती है। वे अकाउंट की स्थिति और तकनीकी लॉग देख सकते हैं, लेकिन आपके केस की सामग्री कभी नहीं।',
    '',
    '## सबूत की फाइलें',
    '',
    'आपके अपलोड किए फोटो और कागज़ात प्राइवेट रूप से रखे जाते हैं, वायरस की जांच के बाद केस संभालने वाले केसवर्कर्स को ही दिखते हैं, और एक सीमित समय बाद हटा दिए जाते हैं।',
    '',
    '## डेटा कितने समय तक रखा जाता है',
    '',
    'अकाउंट का रिकॉर्ड जब तक अकाउंट चालू है तब तक रखा जाता है। शिकायत और केस के रिकॉर्ड केस बंद होने के बाद भी एक समय तक रखे जाते हैं ताकि एक ही कारोबारी से बार-बार होने वाली गलतकारी पहचानी जा सके। सबूत की फाइलें नियमित रूप से हटाई जाती हैं। तकनीकी लॉग सुरक्षा के लिए थोड़े समय के लिए रखे जाते हैं।',
    '',
    '## डेटा हटाना या निकालना',
    '',
    'आप वर्कर ऐप से अपना पूरा रिकॉर्ड PDF, CSV या JSON में खुद निकाल सकते हैं। अकाउंट और डेटा हटाने का अनुरोध आप प्रोफ़ाइल से कर सकते हैं, या अपने NGO केसवर्कर से कह सकते हैं। हटाने के बाद आपकी निजी जानकारी हट जाती है; जहाँ क़ानून ज़रूरी समझे, कुछ केस रिकॉर्ड बिना नाम के रखे जा सकते हैं।',
    '',
    '## लोकेशन',
    '',
    'आपकी लोकेशन सिर्फ तब इस्तेमाल होती है जब आप चेक-इन या शिकायत के साथ जोड़ते हैं, और वह भी तभी जब आप पहले सहमति का बॉक्स टिक करें। यह उस अलर्ट या केस के केसवर्कर्स को ही दिखती है।',
    '',
    '## नीति में बदलाव',
    '',
    'नीति बदलने पर पुराने वर्ज़न उपलब्ध रहते हैं, ताकि आप देख सकें कि कब और क्या बदला।',
    '',
    '---',
    '',
    '*ड्राफ्ट — कानूनी समीक्षा लंबित। यह पहचान पायलट के लिए बनाया गया साधारण भाषा का ड्राफ्ट है। इसे अंतिम नीति मानने या प्रकाशित करने से पहले योग्य वकील की समीक्षा और स्वीकृति ज़रूरी है।*',
  ].join('\n');
  const termsEn = [
    '## What Pehchaan is',
    '',
    'Pehchaan is a record-keeping and referral tool for migrant and informal workers. It helps you keep your own record of wages, safety, and complaints, and connects you to partner NGOs that can assist you.',
    '',
    '## What Pehchaan is not',
    '',
    '**Pehchaan does not replace emergency services, police, courts, or labour departments.** In an emergency, contact your local emergency number first. Pehchaan organizes information so those systems and support organizations can act; it cannot itself rescue, investigate, order payment, or enforce the law.',
    '',
    '## Acceptable use',
    '',
    'Do not use Pehchaan to file complaints you know are false, to harass anyone, or to upload unlawful content. Accounts that repeatedly abuse the platform may be flagged for review and, after human review, suspended.',
    '',
    '## Your account responsibilities',
    '',
    'Your account is tied to your phone number. Keep control of your phone and do not let others file complaints from your account. Give accurate details in your profile so a caseworker can reach you about your case. You are responsible for the truthfulness of what you record and upload.',
    '',
    '## Employer and NGO responsibilities',
    '',
    'Employers and NGOs approved on Pehchaan must give truthful registration information, use case and wage data only for the purposes described in the Privacy Policy, and never pressure a worker about their use of the platform.',
    '',
    '## No guarantee of outcome',
    '',
    'Pehchaan cannot guarantee that a complaint leads to a particular result, that a scheme listed means you are eligible, or that reference wage rates match every notification. Decisions rest with the authorities, courts, and organizations concerned.',
    '',
    '## Changes and termination',
    '',
    'These terms may change; old versions stay available. You may stop using Pehchaan and request deletion at any time.',
    '',
    '---',
    '',
    '*DRAFT — PENDING LEGAL REVIEW. To be reviewed and approved by a qualified lawyer before being relied upon or published as the final terms.*',
  ].join('\n');
  const termsHi = [
    '## पहचान क्या है',
    '',
    'पहचान प्रवासी और अनौपचारिक श्रमिकों के लिए रिकॉर्ड रखने और सही संस्था से जोड़ने वाला एक साधन है। यह आपको अपनी मजदूरी, सुरक्षा और शिकायतों का अपना रिकॉर्ड रखने, और साझेदार NGO तक पहुंचने में मदद करता है।',
    '',
    '## पहचान क्या नहीं है',
    '',
    '**पहचान आपात सेवाओं, पुलिस, अदालतों या श्रम विभाग की जगह नहीं लेती।** आपात स्थिति में सबसे पहले अपना स्थानीय आपात नंबर डायल करें। पहचान जानकारी व्यवस्थित करती है ताकि सही संस्था सही कदम उठा सके; यह खुद किसी को बचा नहीं सकती, जांच नहीं कर सकती, भुगतान का आदेश नहीं दे सकती, और क़ानून लागू नहीं करा सकती।',
    '',
    '## सही इस्तेमाल',
    '',
    'पहचान का इस्तेमाल झूठी शिकायत, किसी को परेशान करने, या ग़ैरक़ानूनी सामग्री अपलोड करने के लिए न करें। बार-बार दुरुपयोग करने वाले अकाउंट समीक्षा के लिए चिह्नित होते हैं और मानव-समीक्षा के बाद रोके जा सकते हैं।',
    '',
    '## आपके अकाउंट की ज़िम्मेदारी',
    '',
    'आपका अकाउंट आपके मोबाइल नंबर से जुड़ा है। अपने फोन का ध्यान रखें और दूसरों को अपने अकाउंट से शिकायत न करने दें। प्रोफ़ाइल में सही जानकारी दें ताकि केसवर्कर आपसे संपर्क कर सके। आप जो रिकॉर्ड और अपलोड करते हैं उसकी सच्चाई के लिए आप ज़िम्मेदार हैं।',
    '',
    '## एम्प्लॉयर और NGO की ज़िम्मेदारी',
    '',
    'पहचान पर स्वीकृत एम्प्लॉयर और NGO सच्ची पंजीकरण जानकारी देंगे, केस और मजदूरी डेटा का उपयोग केवल प्राइवेसी पॉलिसी में बताए उद्देश्यों के लिए करेंगे, और वर्कर के प्लेटफॉरम इस्तेमाल पर कोई दबाव नहीं डालेंगे।',
    '',
    '## नतीजे की गारंटी नहीं',
    '',
    'पहचान यह गारंटी नहीं देती कि शिकायत से कोई खास नतीजा मिलेगा, कि सूचीबद्ध योजना के लिए आप पात्र हैं, यि रेफ़रेंस मजदूरी दर हर अधिसूचना से मेल खाती है। निर्णय संबंधित प्राधिकरण, अदालतों और संस्थाओं के पास रहता है।',
    '',
    '## बदलाव और समाप्ति',
    '',
    'ये शर्तें बदल सकती हैं; पुराने वर्ज़न उपलब्ध रहते हैं। आप कभी भी पहचान का उपयोग बंद कर सकते हैं और डेटा हटाने का अनुरोध कर सकते हैं।',
    '',
    '---',
    '',
    '*ड्राफ्ट — कानूनी समीक्षा लंबित। अंतिम शर्तें मानने या प्रकाशित करने से पहले योग्य वकील की समीक्षा और स्वीकृति ज़रूरी है।*',
  ].join('\n');
  // Phase 35: the exact on-screen consent text shown before a worker's first
  // data submission. Written for a first-time smartphone user, not legal
  // boilerplate. Kept as a legal page so changes are versioned.
  const consentEn = [
    'Before you save anything in Pehchaan, here is what happens with it.',
    '',
    '- What you save (wages, check-ins, complaints, photos) is stored so you have your own proof.',
    '- A caseworker of the NGO helping you can see your complaint and photos. Others cannot.',
    '- An employer sees only the wage records you agree to share. Never your complaints.',
    '- Your location is shared only when you allow it for a check-in or complaint.',
    '- You can download or delete your record anytime from the app.',
    '',
    'Nothing here is a guarantee. In an emergency, call your local emergency number first.',
    '',
    '*DRAFT — PENDING LEGAL REVIEW.*',
  ].join('\n');
  const consentHi = [
    'पहचान में कुछ भी सेव करने से पहले, समझ लें कि उसके साथ क्या होगा।',
    '',
    '- आप जो सेव करते हैं (मजदूरी, चेक-इन, शिकायतें, तस्वीरें) वह इसलिए रखा जाता है कि आपके पास अपना सबूत रहे।',
    '- आपकी मदद करने वाले NGO का केसवर्कर आपकी शिकायत और तस्वीरें देख सकता है। बाकी लोग नहीं।',
    '- एम्प्लॉयर केवल वही मजदूरी रिकॉर्ड देखता है जो आप साझा करने को कहते हैं। शिकायतें कभी नहीं।',
    '- आपकी लोकेशन सिर्फ तब जाती है जब आप चेक-इन या शिकायत के लिए इजाज़त देते हैं।',
    '- अपना रिकॉर्ड आप कभी भी ऐप से डाउनलोड या डिलीट कर सकते हैं।',
    '',
    'यह कोई गारंटी नहीं है। आपात स्थिति में सबसे पहले अपना आपात नंबर डायल करें।',
    '',
